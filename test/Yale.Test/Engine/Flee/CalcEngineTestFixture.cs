...
//using Yale.Engines;
//using Yale.Engines.Flee;
//using Yale.Expression;
//using Yale.Expression.Flee;
//using Assert = Microsoft.VisualStudio.TestTools.UnitTesting.Assert;

//namespace Yale.Test.Engines.Flee
//{
//    [TestFixture]
...
//        {
//            //Todo: fix this test
//            var expression = "a AND NOT b AND NOT c AND d";
//            var expressionVariables = new Dictionary<string, object>();
...
//            var dynamicExpression = context.CompileDynamic(expression);
//            foreach (var expressionVariable in expressionVariables.Keys)
