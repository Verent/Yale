...
internal sealed class LookAheadSet
{
     ...
     */
    public LookAheadSet(int maxLength) => this.maxLength = maxLength;
     ...
     *         false otherwise
     */
    private bool Contains(Sequence elem) => FindSequence(elem) is not null;
     ...
     */
    public void Add(TokenId token) => Add(new Sequence(false, token));
     ...
     */
    public void AddEmpty() => Add(new Sequence());
     ...
     */
    private void Remove(Sequence seq) => elements.Remove(seq);
    ...
    private sealed class Sequence
    {
         ...
         *         false otherwise
         */
        public bool Equals(Sequence seq) => tokens.SequenceEqual(seq.tokens);
         ...
         *         false otherwise
         */
        public bool IsRepetitive() => repeat;
