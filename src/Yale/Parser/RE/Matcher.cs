...
internal sealed class Matcher
{
     ...
     * @since 1.5
     */
    public bool IsCaseInsensitive() => ignoreCase;
     ...
     * @since 1.5
     */
    public void Reset(string str) => Reset(new ReaderBuffer(new StringReader(str)));
     ...
     *         false otherwise
     */
    public bool HasReadEndOfString() => endOfString;
     ...
     *             an input stream
     */
    public bool MatchFromBeginning() => MatchFrom(0);
     ...
     */
    internal void SetReadEndOfString() => endOfString = true;
}
