...
internal sealed class ProductionPatternAlternative
{
     ...
     */
    public ProductionPatternElement GetElement(int pos) => this[pos];
     ...
     *         false otherwise
     */
    public bool IsMatchingEmpty() => GetMinElementCount() == 0;
     ...
     */
    internal void SetPattern(ProductionPattern pattern) => Pattern = pattern;
     ...
     */
    public void AddElement(ProductionPatternElement elem) => elements.Add(elem);
     ...
     */
    public override int GetHashCode() => elements.Count.GetHashCode();
