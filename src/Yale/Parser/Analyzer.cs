...
internal class Analyzer
{
     ...
     * @since 1.5
     */
    public virtual Production NewProduction(ProductionPattern pattern) => new(pattern);

    public virtual void Enter(Production production) { }

    public virtual void Enter(Token token) { }

    public virtual Token Exit(Token token) => token;

    public virtual Production Exit(Production production) => production;
