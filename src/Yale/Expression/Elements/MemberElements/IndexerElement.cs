...
namespace Yale.Expression.Elements.MemberElements
{
    ...
    internal class IndexerElement : MemberElement
    {
        ...
        protected override void ResolveInternal()
        {
            ...
            {
                throw CompileException(CompileErrors.TypeNotArrayAndHasNoIndexerOfType, CompileExceptionReason.TypeMismatch, target.Name, _indexerElements);
            }
        }
        ...
        private void SetupArrayIndexer()
        {
            ...
            {
                throw CompileException(CompileErrors.MultiArrayIndexNotSupported, CompileExceptionReason.TypeMismatch);
            }
            else if (ImplicitConverter.EmitImplicitConvert(_indexerElement.ResultType, typeof(Int32), null) == false)
            {
                throw CompileException(CompileErrors.ArrayIndexersMustBeOfType, CompileExceptionReason.TypeMismatch, typeof(Int32).Name);
            }
        }
