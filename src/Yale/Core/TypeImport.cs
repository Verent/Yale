...
namespace Yale.Core
{
    ...
    internal sealed class TypeImport : ImportBase
    {
        ...
        {
            return string.Equals(typeName, Target.Name, Options.MemberStringComparison)
                ? Target
                : null;
        }
        ...
        {
            return import is TypeImport otherSameType
                && ReferenceEquals(Target, otherSameType.Target);
        }
